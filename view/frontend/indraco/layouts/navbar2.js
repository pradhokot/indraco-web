      ...
      <div id="sidenav" class="offcanvas-lg offcanvas-start" tabindex="-1">
         ...
         <div class="offcanvas-body container-lg align-items-center">
            <ul class="navbar-nav text-capitalize column-gap-lg-3">
               <li class="nav-item">
                  <a href="about.html" class="nav-link px-0 text-nowrap">tentang kami</a>
               </li>
               <li class="nav-item nav-devider py-2"><div class="vr h-100"></div></li>
               <li class="nav-item">
               ...
               <li class="nav-item nav-devider py-2"><div class="vr h-100"></div></li>
               <li class="nav-item">
                  <a href="businesses.html" class="nav-link px-0 text-nowrap">bisnis</a>
               </li>
               <li class="nav-item nav-devider py-2"><div class="vr h-100"></div></li>
               <li class="nav-item">
               ...
               <li class="nav-item nav-devider py-2"><div class="vr h-100"></div></li>
               <li class="nav-item">
                  <a href="news.html" class="nav-link px-0 text-nowrap">berita & acara</a>
               </li>
               <li class="nav-item nav-devider py-2"><div class="vr h-100"></div></li>
               <li class="nav-item">
                  <a href="#" class="nav-link px-0 text-nowrap">brosur</a>
               </li>
               <li class="nav-item nav-devider py-2"><div class="vr h-100"></div></li>
               <li class="nav-item">
                  <a href="career.html" class="nav-link px-0 text-nowrap">karir</a>
               </li>
               <li class="nav-item nav-devider py-2"><div class="vr h-100"></div></li>
               <li class="nav-item">
                  <a href="contact.html" class="nav-link px-0 text-nowrap">kontak</a>
               </li>
               <li class="nav-item nav-devider py-2"><div class="vr h-100"></div></li>
            </ul>
